<?php
class IMIC_Framework_spacing extends IMIC_Framework{	
	...
	*/
	function render(){
		...
		if ( isset( $this->field['all'] ) && $this->field['all'] == true ) {
			echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el-icon-fullscreen icon-large"></i></span><input type="text" class="imic-spacing-all imic-spacing-input mini'.$this->field['class'].'" placeholder="'.__('All','imic-framework').'" rel="'.$this->field['id'].'-all" value="'.$this->value['top'].'"></div>';
		}

		echo '<input type="hidden" class="imic-spacing-value" id="'.$this->field['id'].'-top" name="'.$this->args['opt_name'].'['.$this->field['id'].']['.$this->field['mode'].'top]" value="'.$this->value['top'].(!empty($this->value['top']) ? $this->value['units'] : '').'">';
		echo '<input type="hidden" class="imic-spacing-value" id="'.$this->field['id'].'-right" name="'.$this->args['opt_name'].'['.$this->field['id'].']['.$this->field['mode'].'right]" value="'.$this->value['right'].(!empty($this->value['right']) ? $this->value['units'] : '').'">';
		echo '<input type="hidden" class="imic-spacing-value" id="'.$this->field['id'].'-bottom" name="'.$this->args['opt_name'].'['.$this->field['id'].']['.$this->field['mode'].'bottom]" value="'.$this->value['bottom'].(!empty($this->value['bottom']) ? $this->value['units'] : '').'">';
		echo '<input type="hidden" class="imic-spacing-value" id="'.$this->field['id'].'-left" name="'.$this->args['opt_name'].'['.$this->field['id'].']['.$this->field['mode'].'left]" value="'.$this->value['left'].(!empty($this->value['left']) ? $this->value['units'] : '').'">';
		...
		if ( !isset( $this->field['all'] ) || $this->field['all'] !== true ) :
			...
			**/
			if ($this->field['top'] === true):
				echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el-icon-arrow-up icon-large"></i></span><input type="text" class="imic-spacing-top imic-spacing-input mini'.$this->field['class'].'" placeholder="'.__('Top','imic-framework').'" rel="'.$this->field['id'].'-top" value="'.$this->value['top'].'"></div>';
		  	endif;
			...
			**/
			if ($this->field['right'] === true):
				echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el-icon-arrow-right icon-large"></i></span><input type="text" class="imic-spacing-right imic-spacing-input mini'.$this->field['class'].'" placeholder="'.__('Right','imic-framework').'" rel="'.$this->field['id'].'-right" value="'.$this->value['right'].'"></div>';
		  	endif;
			...
			**/
			if ($this->field['bottom'] === true):
				echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el-icon-arrow-down icon-large"></i></span><input type="text" class="imic-spacing-bottom imic-spacing-input mini'.$this->field['class'].'" placeholder="'.__('Bottom','imic-framework').'" rel="'.$this->field['id'].'-bottom" value="'.$this->value['bottom'].'"></div>';
		  	endif;
			...
			**/
			if ($this->field['left'] === true):
				echo '<div class="field-spacing-input input-prepend"><span class="add-on"><i class="el-icon-arrow-left icon-large"></i></span><input type="text" class="imic-spacing-left imic-spacing-input mini'.$this->field['class'].'" placeholder="'.__('Left','imic-framework').'" rel="'.$this->field['id'].'-left" value="'.$this->value['left'].'"></div>';
		  	endif;		
			...
			**/
			...
			if ( $this->field['units'] !== false && !isset( $absolute ) && $this->field['display_units'] == true ):
				...
				echo '<div class="select_wrapper spacing-units" original-title="'.__('Units','imic-framework').'">';
				echo '<select data-placeholder="'.__('Units','imic-framework').'" class="imic-spacing imic-spacing-units select'.$this->field['class'].'" original-title="'.__('Units','imic-framework').'" name="'.$this->args['opt_name'].'['.$this->field['id'].'][units]" id="'. $this->field['id'].'_units">';
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			'imic-field-spacing-js', 
			IMIC_Framework::$_url.'inc/fields/spacing/field_spacing.min.js', 
		...
		wp_enqueue_style(
			'imic-field-spacing-css', 
			IMIC_Framework::$_url.'inc/fields/spacing/field_spacing.css', 
			time(),
			true
		);	
