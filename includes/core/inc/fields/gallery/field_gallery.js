            ...
            click: function(event){
                ...
                frame.state('gallery-edit').on( 'update', function( selection ) {
                    ...
                    var ids = selection.models.map(function(e){
                        ...
                        preview_html = "<a class='of-uploaded-image' href='"+preview_img+"'><img class='imic-option-image' src='"+preview_img+"' alt='' /></a>";
                        current_gallery.find(".screenshot").append(preview_html);
                        return e.id;
                    });
                    current_gallery.find('.gallery_values').val(ids.join(','));
                    imic_change( current_gallery.find( '.gallery_values' ) );
