<?php
class IMIC_Framework_typography extends IMIC_Framework{
    ...
    function render(){
		...
		if ($this->field['font-family'] === true):
	        ...
	        echo '<div id="'.$this->field['id'].'" class="imic-typography-container" data-id="'.$this->field['id'].'" data-units="'.$unit.'">';
              ...
              echo '<input type="hidden" class="imic-typography-font-family '.$this->field['class'].'" name="'.$this->args['opt_name'].'['.$this->field['id'].'][font-family]" value="'.$this->value['font-family'].'" data-id="'.$this->field['id'].'"  />';
              echo '<div class="select_wrapper typography-family" style="width: 220px; margin-right: 5px;">';
              echo '<select data-placeholder="'.__('Font family','imic-framework').'" class="imic-typography imic-typography-family '.$this->field['class'].'" id="'.$this->field['id'].'-family" data-id="'.$this->field['id'].'" data-value="'.$fontFamily[0].'">';
              ...
              if ( isset($this->field['update_weekly']) && $this->field['update_weekly'] === true && $this->field['google'] === true && !empty( $this->parent->args['google_api_key'] ) ) {
                  echo '<optgroup label="'.__('Standard Fonts', 'imic-framework').'">';
                  if( file_exists( IMIC_Framework::$_dir.'inc/fields/typography/googlefonts.html' )) {
                    // Keep the fonts updated weekly
                    $weekback = strtotime( date('jS F Y', time() + (60 * 60 * 24 * -7) ) );
                    $last_updated = filemtime( IMIC_Framework::$_dir.'inc/fields/typography/googlefonts.html' );
                    if ( $last_updated < $weekback ) {
                      unlink( IMIC_Framework::$_dir.'inc/fields/typography/googlefonts.html' );
                      unlink( IMIC_Framework::$_dir.'inc/fields/typography/googlefonts.json' );
                    }                 
                  }
              }
              ...
              if ($this->field['google'] == true && !empty( $this->parent->args['google_api_key'] ) ) {
                  ...
                  if( file_exists(IMIC_Framework::$_dir.'inc/fields/typography/googlefonts.html' )) {
                    echo $wp_filesystem->get_contents( IMIC_Framework::$_dir.'inc/fields/typography/googlefonts.html' );
                  }
              }
              ...
              if ($this->field['google'] === true) { 
                  ...
                  echo '<input type="hidden" class="imic-typography-google'.$this->field['class'].'" id="'.$this->field['id'].'-google" name="'.$this->args['opt_name'].'['.$this->field['id'].'][google]" type="text" value="'. $this->field['google'] .'" data-id="'.$this->field['id'].'" />';            
              }
            ...
            if ($this->field['font-style'] === true || $this->field['font-weight'] === true):
                echo '<div class="select_wrapper typography-style" original-title="'.__('Font style','imic-framework').'">';
                ...
                echo '<select data-placeholder="'.__('Style','imic-framework').'" class="imic-typography imic-typography-style select'.$this->field['class'].'" original-title="'.__('Font style','imic-framework').'" id="'. $this->field['id'].'_style" data-id="'.$this->field['id'].'" data-value="'.$style.'">';
            ...
            if ($this->field['subsets'] === true && $this->field['google'] === true):
                echo '<div class="select_wrapper typography-script tooltip" original-title="'.__('Font subsets','imic-framework').'">';
                echo '<select data-placeholder="'.__('Subsets','imic-framework').'" class="imic-typography imic-typography-subsets'.$this->field['class'].'" original-title="'.__('Font script','imic-framework').'"  id="'.$this->field['id'].'-subsets" name="'.$this->args['opt_name'].'['.$this->field['id'].'][subsets]" data-value="'.$this->value['subsets'].'" data-id="'.$this->field['id'].'" >';
            ...
            if ($this->field['font-size'] === true):
                echo '<div class="input-append"><input type="text" class="span2 imic-typography-size mini'.$this->field['class'].'" placeholder="'.__('Size','imic-framework').'" id="'.$this->field['id'].'-size" name="'.$this->args['opt_name'].'['.$this->field['id'].'][font-size]" value="'.str_replace($unit, '', $this->value['font-size']).'" data-value="'.str_replace($unit, '', $this->value['font-size']).'"><span class="add-on">'.$unit.'</span></div>';
            ...
            if ($this->field['line-height'] === true):
                echo '<div class="input-append"><input type="text" class="span2 imic-typography imic-typography-height mini'.$this->field['class'].'" placeholder="'.__('Height','imic-framework').'" id="'.$this->field['id'].'-height" value="'.str_replace($unit, '', $this->value['line-height']).'" data-value="'.str_replace($unit, '', $this->value['line-height']).'"><span class="add-on">'.$unit.'</span></div>';
            ...
            if ($this->field['word-spacing'] === true):
                echo '<div class="input-append"><input type="text" class="span2 imic-typography imic-typography-word mini'.$this->field['class'].'" placeholder="'.__('Word Spacing','imic-framework').'" id="'.$this->field['id'].'-word" value="'.str_replace($unit, '', $this->value['word-spacing']).'" data-value="'.str_replace($unit, '', $this->value['word-spacing']).'"><span class="add-on">'.$unit.'</span></div>';
            ...
            if ($this->field['letter-spacing'] === true):
                echo '<div class="input-append"><input type="text" class="span2 imic-typography imic-typography-letter mini'.$this->field['class'].'" placeholder="'.__('Letter Spacing','imic-framework').'" id="'.$this->field['id'].'-letter" value="'.str_replace($unit, '', $this->value['letter-spacing']).'" data-value="'.str_replace($unit, '', $this->value['letter-spacing']).'"><span class="add-on">'.$unit.'</span></div>';
            ...
            if ($this->field['font-family'] === true && $this->field['google'] === true) { 
              // Set a flag so we know to set a header style or not
                echo '<input type="hidden" class="imic-typography-google'.$this->field['class'].'" id="'.$this->field['id'].'-google" name="'.$this->args['opt_name'].'['.$this->field['id'].'][google]" type="text" value="'. $this->field['google'] .'" data-id="'.$this->field['id'].'" data-id="'.$this->field['id'].'"  />';            
            
                if ($this->field['font-backup'] === true) {
                  echo '<div class="select_wrapper typography-family-backup" style="width: 220px; margin-right: 5px;">';
                  echo '<select data-placeholder="'.__('Backup Font Family','imic-framework').'" name="'.$this->args['opt_name'].'['.$this->field['id'].'][font-backup]" class="imic-typography imic-typography-family-backup '.$this->field['class'].'" id="'.$this->field['id'].'-family-backup" data-id="'.$this->field['id'].'" data-value="'.$this->value['font-backup'].'">';
                  echo '<option data-google="false" data-details="" value=""></option>';
                  foreach ($this->field['fonts'] as $i=>$family) {
            ...
            if ($this->field['color'] === true):
                ...
                echo '<input data-default-color="'.$default.'" class="imic-color imic-typography-color'.$this->field['class'].'" original-title="'.__('Font color','imic-framework').'" id="'.$this->field['id'].'-color" name="'.$this->args['opt_name'].'['.$this->field['id'].'][color]" type="text" value="'. $this->value['color'] .'" data-id="'.$this->field['id'].'" />';
            endif;
    ...
    function enqueue(){
        ...
        wp_enqueue_script(
            'imic-field-typography-js',
            IMIC_Framework::$_url.'inc/fields/typography/field_typography.min.js',
            array('jquery', 'wp-color-picker', 'imic-field-color-js', 'select2-js', 'jquery-numeric'),
            time(),
            true
        );

        wp_enqueue_style(
            'imic-field-typography-css',
            IMIC_Framework::$_url.'inc/fields/typography/field_typography.css',
            time(),
            true
        );
    ...
    function output() {
      ...
      $version = '';
      if (!empty($this->parent->options['IMIC_last_saved'])) {
        $version = $this->parent->options['IMIC_last_saved'];
      }

      if ( !empty( $fonts ) && filter_var($this->parent->args['output'], FILTER_VALIDATE_BOOLEAN) ) {
        echo '<link rel="stylesheet" id="imic-google-fonts-css"  href="'.$this->makeGoogleWebfontLink( $fonts ).'&v='.$version.'" type="text/css" media="all" />';
        //wp_register_style( 'imic-google-fonts', $this->makeGoogleWebfontLink( $fonts ), '', $version );
        //wp_enqueue_style( 'imic-google-fonts' ); 
      }
      if ( !empty( $outCSS ) ) {
        echo '<style type="text/css" class="imic-'.$this->field['type'].'">'.$outCSS.'</style>';  
      }
    }
    ...
    function getGoogleFonts($wp_filesystem) {
        ...
        if( !file_exists( IMIC_Framework::$_dir.'inc/fields/typography/googlefonts.json' ) ) {
            ...
            if ($result['response']['code'] == 200) {
                ...
                if ( !empty( $googleArray ) ) {
                    $wp_filesystem->put_contents(
                        IMIC_Framework::$_dir.'inc/fields/typography/googlefonts.json',
        ...
        if (empty($googleArray)) {
            $googleArray = json_decode($wp_filesystem->get_contents(IMIC_Framework::$_dir.'inc/fields/typography/googlefonts.json' ), true );
        }
        $gfonts = '<optgroup label="'.__('Google Webfonts', 'imic-framework').'">';
        ...
        $wp_filesystem->put_contents(
            IMIC_Framework::$_dir.'inc/fields/typography/googlefonts.html',
            $gfonts,
            FS_CHMOD_FILE // predefined mode settings for WP files
        );
    }//function
