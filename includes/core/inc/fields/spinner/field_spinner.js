/* global imic_change, imicSpinners */
jQuery(document).ready(function() {
    jQuery('.imic_spinner').each(function() {
        //slider init
        var spinner = imicSpinners[jQuery(this).attr('rel')];
    ...
    jQuery(".spinner-input").focus(function() {
        ...
        var spinner = imicSpinners[jQuery(this).attr('id')];
